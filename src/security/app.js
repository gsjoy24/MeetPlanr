                        ...
                        <div className="flex">
                            ...
                            <div className="mt-2 ml-5">
                                ...
                                <p className="text-[#425466] text-[19px] leading-8">
                                    Hundreds of coworkers use Calendly – bring
                                    them all together in one secure, managed
                                    account.
                                </p>
                            </div>
                        </div>
                    ...
                    <div>
                        <div className="flex">
                            ...
                            <div className="mt-2 ml-5">
                                ...
                                <p className="text-[#425466] text-[19px] leading-8">
                                    Single-sign-on, SCIM, and more make it easy
                                    to onboard/offboard users, mandate
                                    passwords, and more.
                                </p>
                            </div>
                        </div>
                    ...
                    <div>
                        <div className="flex">
                            ...
                            <div className="mt-2 ml-5">
                                ...
                                <p className="text-[#425466] text-[19px] leading-8">
                                    Manage how your coworkers create meeting
                                    types, send consistent reminders, and adhere
                                    to brand standards.
                                </p>
                            </div>
                        </div>
