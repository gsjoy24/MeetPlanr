            ...
            <div className="lg:mt-[140px] my-20">
               <div className="text-center">
                  ...
                  <p className="md:w-[600px] lg:w-[563px] mx-auto font-normal Normal text-[20px] text-[#5A7795]">
                     When it comes to choosing the right Price, we know how easy
                     it is to get overwhelmed with the number.
                  </p>
               </div>

               <div className="grid lg:mt-[50px] grid-cols-1 gap-[30px] lg:grid-cols-3 md:grid-cols-2 mt-10">
                  {/* Plan 1 */}
                  <div className="card group lg:w-[310px] rounded-3xl xl:w-auto bg-base-100 hover:bg-[#0B3558] text-[#0B3558] hover:text-white border shadow-md pb-10 duration-300">
                     <div className="px-5">
                        <p className="text-[22px] uppercase mt-[30px] font-bold">
                           Basic
                        </p>
                        <div className="flex items-center lg:text-[42px] uppercase my-2 font-bold">
                           <span className="lg:text-[40px] mt-[5px]">Free</span>
                        </div>
                        <p className="text-[17px] uppercase font-bold Bold">
                           Yearly
                        </p>
                     </div>
                  ...
                  {/* Plan 2 */}
                  <div className="card lg:w-[310px] rounded-3xl xl:w-auto bg-[#0B3558] text-white border shadow-md pb-10">
                     <div className="px-5">
                        <div className="mt-[30px] flex items-center">
                           <span className="text-[22px] uppercase font-bold mr-3">
                              Standard
                           </span>
                     ...
                     <Link
                        href=""
                        className="text-white text-sm px-5 mt-5 underline font-medium"
                     >
                        Get Your 30 Day Free Trail
                     </Link>
                  </div>
                  ...
                  <div className="card group lg:w-[310px] rounded-3xl xl:w-auto bg-base-100 hover:bg-[#0B3558] text-[#0B3558] hover:text-white border shadow-md pb-10 duration-300">
                     <div className="px-5">
                        <p className="text-[22px] uppercase mt-[30px] font-bold Medium">
                           Premium
                        </p>
                        <div className="flex items-center lg:text-[42px] uppercase my-2 font-bold Medium">
                           <span className="lg:text-[40px] mt-[5px] -mr-1">
