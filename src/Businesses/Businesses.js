		...
		<div>
				...
				<Container>
					<div className="lg:grid-cols-2 grid grid-cols-1 gap-16">
						<div className="lg:mt-10">
							<h3 className="text-[#465AF7] font-semibold uppercase">MeetPlanr FOR TEAMS & COMPANIES</h3>
							...
							<p className="text-[18px] text-[#5A7795] md:w-[550px] mb-10 leading-8">
								Scheduling automation enables everyone to achieve team goals more quickly, whether they are related to
								sales income, the hiring pipeline, or customer retention.
							</p>
							<Link
								href="/my-account"
						...
						<div>
							<Image src={img1} alt="Business_img1" data-testid="image1" className="lg:-mt-16" />
						</div>
					</div>
				</Container>
			</section>
			...
			<Container>
				<section className="py-12">
					<div className="pb-14 text-center" data-aos="fade-up" data-aos-duration="300">
						<h3 className="text-[#465AF7] font-semibold uppercase">HOW MeetPlanr WORKS FOR TEAMS</h3>
					...
					<div className="lg:grid-cols-2 grid grid-cols-1 gap-20">
						<div data-aos="zoom-in" data-aos-duration="900" className="md:order-last lg:order-first order-last">
							<Image src={img2} alt="Business_img2" data-testid="image2" className="lg:mt-10" />
						</div>
						...
						<div data-aos="fade-up" data-aos-duration="600" className="lg:mt-8">
							...
							<p className="text-[18px] text-[#5A7795] md:w-[680px] lg:w-[520px] lg:mb-10 leading-8">
								Collaborative scheduling means you can book meetings with the whole team, any member of the team, or
								based on more complex routing logic - so the right members of your team are always ready to meet.
							</p>
						</div>
					</div>
					...
					<div className="lg:grid-cols-2 grid grid-cols-1 gap-16 mt-20">
						<div data-aos="fade-up" data-aos-duration="600">
							...
							<p className="text-[18px] text-[#5A7795] md:w-[680px] lg:w-[480px] lg:mb-10 leading-8">
								Scheduling automation eliminates time-consuming tasks so your team can focus on higher priorities. With
								actionable insights into your teams scheduling activities and integrations with your teams favorite
								tools, you can empower your team to work more efficiently.
							</p>
						</div>

						<div data-aos="zoom-in" data-aos-duration="900" className="md:order-last">
							<Image src={img3} alt="Business_img3" data-testid="image3" className="lg:-mt-8" />
						</div>
					</div>

					<div className="lg:grid-cols-2 grid grid-cols-1 gap-16 mt-24">
						<div data-aos="zoom-in" data-aos-duration="900" className="md:order-last lg:order-first order-last">
							<Image src={img4} alt="Business_img4" data-testid="image4" className="w-[520px]" />
						</div>
						...
						<div data-aos="fade-up" data-aos-duration="600" className="lg:mt-5">
							...
							<p className="text-[18px] text-[#5A7795] md:w-[680px] lg:w-[520px] lg:mb-10 leading-8">
								From pre-call email questionnaires to defined Event Type details, meeting best practices can be
								automatically applied across your team. These templates and workflows increase engagement and ensure
								consistent, professional communications with your customers and candidates.
							</p>
						</div>
					</div>
				</section>
			...
			<section className="py-12 bg-[#f8f8f8]">
				<Container>
					<div className="pb-14 text-center" data-aos="fade-up" data-aos-duration="600">
						<h3 className="text-[#465AF7] font-semibold uppercase">MeetPlanr FOR ENTERPRISE</h3>
					...
					<div className="lg:grid-cols-2 grid grid-cols-1 gap-16 my-10">
						<div data-aos="fade-up" data-aos-duration="600" className="lg:mt-20">
							<h3 className="text-[#465AF7] font-semibold uppercase">A SINGLE CENTRAL LOCATION</h3>
							...
							<p className="text-[18px] text-[#5A7795] md:w-[680px] lg:w-[480px] lg:mb-8 leading-8">
								Manage users and scheduling procedures for your company with ease from one central location.
							</p>
							<Link href="" className="text-[#465AF7] hover:text-[#0B3558] font-semibold flex items-center group">
						...
						<div data-aos="fade-up" data-aos-duration="800" className="md:order-last">
							<Image src={img5} alt="Business_img5" data-testid="image5" className="lg:-mt-8 md:w-[550px]" />
						</div>
					</div>

					<div className="lg:grid-cols-2 grid grid-cols-1 gap-16 my-10">
						<div data-aos="fade-up" data-aos-duration="800">
							<Image src={img6} alt="Business_img6" data-testid="image6" />
						</div>

						<div data-aos="fade-up" data-aos-duration="600" className="lg:mt-20">
							<h3 className="text-[#465AF7] font-semibold uppercase">PER USER, 6 CALENDAR the condition</h3>
							<p className="text-3xl lg:text-4xl text-[#0B3558] md:w-[500px] lg:w-[540px] my-6 font-bold leading-8">
								MeetPlanr for Business
							</p>
							<p className="text-[18px] text-[#5A7795] md:w-[680px] lg:w-[480px] lg:mb-8 leading-8">
								For each user, connect up to six calendars to check availability in real time.
							</p>
							<Link
								href="/pricing"
