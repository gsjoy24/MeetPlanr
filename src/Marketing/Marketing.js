			...
			<Container>
				<section className="mt-16">
					<div className="lg:grid-cols-2 grid grid-cols-1 gap-16">
						<div>
							<h3 className="text-[#465AF7] font-semibold uppercase">MARKETING TEAMS</h3>
							...
							<p className="text-[18px] text-[#5A7795] md:w-[465px] mb-10">
								Create a better experience for high-value prospects, automate the handoff to Sales, and fill your
				...
				<section className="my-40">
					<div className="lg:grid-cols-3 lg:text-start grid grid-cols-1 gap-16 text-center">
						...
						<div className="lg:pb-0 lg:border-r-2 lg:border-b-transparent pb-16 border-b-2">
							...
							<p className="text-[21px] text-[#5A7795] lg:w-[260px] pt-3 pb-8 lg:pb-[92px]">Higher lead conversion</p>
							<div className="lg:justify-normal flex justify-center">
						...
						<div className="">
							...
							<div className="lg:justify-normal flex justify-center">
								<Image src={img4} alt="Marketing Image" className="w-20" />
							</div>
						</div>
					</div>
				</section>
				...
				<Container>
					...
					<div className="lg:grid-cols-2 grid grid-cols-1 gap-16">
						<div data-aos="fade-up" data-aos-duration="700">
							<h3 className="text-[#465AF7] font-semibold uppercase">IMPROVE CONVERSION RATES</h3>
							<p className="text-3xl lg:text-4xl text-[#0B3558] md:w-[520px] lg:w-[420px] my-6 font-semibold leading-8">
								Schedule prospects directly from your marketing campaigns
							</p>
							<p className="text-[18px] text-[#5A7795] md:w-[480px] mb-10 leading-8">
								Instead of “contact us” or “learn more” as the call-to-action in your marketing campaigns, why not “book
								a meeting now?” Convert prospects at the height of their interest and hand leads off to your sales team
								automatically.
							</p>
						</div>
