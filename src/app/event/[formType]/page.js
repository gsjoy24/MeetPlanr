...
const page = ({params}) => {
    ...
    {/*================= Event Form ====================== =*/}
                <div className='w-4/5 border-2 rounded-md shadow-md mx-auto p-5 bg-[#edf1f4]'>
                    ...
                    <form className='flex flex-col w-8/12 mx-auto mt-8' onSubmit={handleSubmit(onSubmit)}>

                        <label className='text-lg font-semibold mb-3' htmlFor='eventName'>Event Name:*</label>
                        <input placeholder='Event Name...' required className='input_field disc_effects' id='eventName' {...register("eventName")} />         

                        <label className='text-lg font-semibold mb-3 mt-5' htmlFor='eventMethod'>Event Method:*</label> 
                        
                        <div className="input_field disc_effects mt-8 relative">
                            {
                                (method == "Google Meet") ? 
                        ...
                        <textarea placeholder='Write your schedule details....' id='description' className='input_field disc_effects min-h-[200px] resize-none' {...register("description")}></textarea>

                        <label className='text-lg font-semibold mb-3 mt-8' htmlFor='duration'>Duration:*</label>
                        <select id='duration' className='input_field disc_effects' {...register("duration")}>
                        ...
                        <div className="grid grid-cols-2 gap-5 mt-8">
                            <div className="">
                                ...
                                <input className='input_field disc_effects' id='eventDate' {...register("eventDate")} type='date' required/> 
                            </div>
                            <div className="">
                                <label className='text-lg font-semibold mb-3' htmlFor='eventTime'>Event Time:*</label>
                                <input className='input_field disc_effects' id='eventTime' {...register("eventTime")} type='time' required/> 
                            </div>
                        </div>
