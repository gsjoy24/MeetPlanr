   ...
   if(!schedule){
    ...
    return (
        ...
        <div className="mt-24 my-8">
           <div className="my-5">
              <button onClick={() => router.back()} className="border border-[#465AF7] text-[#465AF7] w-fit h-fit mx-auto px-3 py-2 rounded-full hover:bg-[#e0e8fa] cursor-pointer transition-all duration-400" >
