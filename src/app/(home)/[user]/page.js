               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-16">
                  <div>
                     ...
                     >
                        ...
                        <div className="collapse-content">
                           <p className="text-[#5A7795]">
                              Accelerate success at every stage of your sales
                     ...
                     >
                        ...
                        <div className="collapse-content">
                           <p className="text-[#5A7795]">
                              Supercharge your lead gen to boost conversion
                              rates and drive more pipeline.
                           </p>
                           <p>
                              <a
                                 href=""
                     ...
                     >
                        ...
                        <div className="collapse-content">
                           <p className="text-[#5A7795]">
                              Integrate best-in-class scheduling to keep every
                              team and opportunity connected.
                           </p>
                           <p>
                              <a
                                 href=""
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-16">
                  ...
                  <div>
                     ...
                     >
                        ...
                        <div className="collapse-content">
                           <p className="text-[#5A7795]">
                              Boost student engagement, increase accessibility
                              to resources, and accelerate the admissions cycle.
                           </p>
                           <p>
                              <a
                                 href=""
                     ...
                     >
                        ...
                        <div className="collapse-content">
                           <p className="text-[#5A7795]">
                              ...
                              team efficiency, and increase project
                              profitability.
                           </p>
                           <p>
                              <a
               ...
               <div className="text-white bg-[#0B3558] rounded-3xl mb-20">
                  <div className="mt-20 text-center sm:w-[500px] md:w-[600px] lg:w-[800px] mx-auto py-14">
                     ...
                     <p className="text-[17px] px-5 mb-10">
                        ...
                        automating communications so you can connect with the
                        right people, faster.
                     </p>
