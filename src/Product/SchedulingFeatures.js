...
const SchedulingFeatures = () => {
	return (
		<div className="text-center pt-12 md:pt-28 bg-[#F7FAFF]">
			<Container>
				<div>
					<h3 className="text-[#465AF7] font-semibold uppercase">MeetPlanr FEATURES</h3>
					<h1 className="md:text-5xl lg:text-6xl text-sky-950 my-8 text-4xl font-bold">
						More than a <span className="text-[#465AF7]">scheduling link</span>
					</h1>
					<p className="text-[22px] text-[#5A7795] lg:w-[710px] mx-auto mb-10">
						MeetPlanr is the scheduling automation platform with team-based scheduling, solutions and integrations for
					...
					<div className="mt-16 mb-20" data-aos="fade-up" data-aos-duration="600">
