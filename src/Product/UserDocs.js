            ...
            <div className="">
               ...
               <div className="md:grid-cols-2 grid items-center gap-16 my-10">
                  <div className=" md:order-2">
                     ...
                     <p className="leading-relaxed text-[18px] text-[#5A7795] lg:w-[470px]">
                        Booking links can be based on different event types -
                        from 15-minute Zoom calls to 30-minute in-person
                        meetings – and rules. Include other members of your
                        team, route the meeting to the right people on your
