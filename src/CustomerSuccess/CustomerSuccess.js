	...
	return (
		<div>
				...
				<section className="mt-28">
					<div className="lg:grid-cols-2 grid grid-cols-1 gap-16">
						<div className="lg:mt-10">
							<h3 className="text-[#465AF7] font-semibold uppercase">CUSTOMER SUCCESS STORIES</h3>
							...
							<p className="text-[18px] text-[#5A7795] md:w-[550px] mb-10">
								Discover how businesses like yours use Intercom to acquire, engage, and support customers. Ensure
								customers can reach you and stay connected at every stage of their journey to improve their experience
						...
						<div>
							<Image src={img1} alt="Marketing Image" className="lg:w-[550px] lg:-mt-16" />
						</div>
					</div>
				</section>
				...
				<section className="mt-40 mb-16">
					<div className="lg:grid-cols-3 lg:text-start grid grid-cols-1 gap-16 text-center">
						...
						<div className="">
							...
							<div className="lg:justify-normal flex justify-center">
								<Image src={img4} alt="Marketing Image" className="w-28" />
							</div>
						</div>
					</div>
				</section>
			...
			<section className="py-16 bg-[#FBFBFB]">
				<Container>
					<div className="lg:grid-cols-2 grid grid-cols-1 gap-16">
						<div className="lg:-mt-5" data-aos="fade-up" data-aos-duration="600">
							<h3 className="text-[#465AF7] font-semibold uppercase">RETAIN AND GROW</h3>
							...
							<p className="text-[18px] text-[#5A7795] md:w-[550px] mb-10 leading-8">
								The way you first meet matters. Facilitate communication and trust-building with your clients, and
								utilise meeting time to address and meet their needs.
							</p>
						</div>

						<div>
							<Image src={img5} alt="Marketing Image" className="lg:w-[550px] lg:-mt-16" />
						</div>
					</div>
				</Container>
			</section>
			...
			<section className="bg-[#F7FAFF] py-20">
				<Container>
					...
					<div className="lg:grid-cols-2 grid grid-cols-1 gap-16">
						<div data-aos="fade-up" data-aos-duration="600" className="lg:mt-10">
							<h3 className="text-[#465AF7] font-semibold uppercase">ACCESS A COMPETITIVE EDGE</h3>
							...
							<p className="text-[18px] text-[#5A7795] md:w-[480px] mb-10 leading-8">
								Grow relationships through one-on-one check-ins, gather your team for a team-wide onboarding, gather a
								group of clients for training and networking, provide special periods for a significant renewal, and
								rotate requests among the team members.
							</p>
						</div>

						<div data-aos="zoom-in" data-aos-duration="800">
							<Image src={img6} alt="Calender" className="md:w-[500px] lg:-mt-20" />
						</div>
					</div>

					<div className="lg:grid-cols-2 grid grid-cols-1 gap-16 mt-32">
						<div data-aos="zoom-in" data-aos-duration="800" className="md:order-last lg:order-first order-last">
							<Image src={img7} alt="Calender" />
						</div>

						<div data-aos="fade-up" data-aos-duration="600" className="lg:mt-20">
							<h3 className="text-[#465AF7] font-semibold uppercase">EMBED MeetPlanr ANYWHERE</h3>
							<p className="text-3xl lg:text-4xl text-[#0B3558] md:w-[520px] lg:w-[420px] my-6 font-semibold leading-8">
								Create a frictionless customer journey
							</p>
							<p className="text-[18px] text-[#5A7795] md:w-[480px] mb-10 leading-8">
								Embed your sales reps’ individual MeetPlanr links into any email marketing campaign, display ad, QR
								code, or landing page, and skip the back and forth by offering prospects the ability to book a meeting
								instantly.
							</p>
						</div>
					</div>
					...
					<div className="lg:grid-cols-2 mt-28 grid grid-cols-1 gap-16">
						<div data-aos="fade-up" data-aos-duration="600" className="lg:mt-10">
							<h3 className="text-[#465AF7] font-semibold uppercase">PARTICIPATE AT ALL PHASES OF THEIR JOURNEY</h3>
							<p className="text-3xl lg:text-4xl text-[#0B3558] md:w-[520px] lg:w-[420px] my-6 font-semibold leading-8">
								Helping clients reach their objectives
							</p>
							<p className="text-[18px] text-[#5A7795] md:w-[480px] mb-10 leading-8">
								Using team pages to provide consumers the freedom to choose how they want to interact with your team,
								whether they require technical support, have a query about pricing, or need to book user training.
							</p>
						</div>

						<div data-aos="zoom-in" data-aos-duration="800">
							<Image src={img8} alt="Calender" className="md:w-[500px] lg:-mt-10" />
						</div>
					</div>
				</Container>
			</section>
			...
			<section className="my-10">
				<Container>
					<div className="text-center" data-aos="fade-up" data-aos-duration="600">
						<p className="text-[#465AF7] font-semibold uppercase">MAKE IT YOUR OWN</p>
						<p className="md:text-4xl lg:text-5xl text-sky-950 my-8 text-4xl font-bold">That’s not all</p>
						<p className="text-[18px] text-[#5A7795] lg:w-[710px] mx-auto mb-10">
							Your day is now free for achievement because scheduling issues and interruptions are not anymore an issue.
						</p>
					</div>
					...
					<div className="mt-20 mb-20">
						<div className="md:grid-cols-3 grid grid-cols-1 gap-16">
							...
							>
								...
								<p className="text-xl text-[#0B3558] font-semibold">Control your availability</p>
							...
							>
								<PiSealCheck className="text-4xl text-[#465AF7]" />
								<p className="text-xl text-[#0B3558] font-semibold">Use custom branding</p>
								<p className="text-[#5A7795]">
									Remove Calendly branding and personalize your scheduling pages with your branding for a customized
									experience.
								</p>
							</div>
							...
							>
								<PiSealCheck className="text-4xl text-[#465AF7]" />
								<p className="text-xl text-[#0B3558] font-semibold">Share teams pages</p>
								<p className="text-[#5A7795]">
									Showcase multiple meeting options and allow your invitees to select the meeting they need.
								</p>
							</div>
						</div>
					</div>
