         ...
         <section className="pt-14 pb-16 bg-[#FBFBFB]">
            <Container>
               ...
               <div className="lg:grid-cols-2 grid grid-cols-1 gap-16 mt-24">
                  ...
                  >
                     <h3 className="text-[#465AF7] font-semibold uppercase">
                        BOOK MEETINGS WITH NEW CLIENTS
                     </h3>
         ...
         <section className="py-14 bg-[#f4f7fd]">
            <Container>
               <div className="lg:grid-cols-2 grid grid-cols-1 gap-16">
                  ...
                  <div
                     className="border rounded-xl p-8 space-y-4 shadow-sm bg-white"
                     data-aos="fade-up"
                  ...
                  <div className="md:grid-cols-3 grid grid-cols-1 gap-16">
                     ...
                     >
                        ...
                        <p className="text-[#5A7795]">
                           &#34;It is simple and obvious. offers features and
                           advantages that I had not considered that further
                     ...
                     >
                        <Image src={img15} alt="logo" className="w-12" />
                        <p className="text-[#5A7795]">
                           &#34;I love how simple it is to send my calendar to
                           clients and how simple it is for them to schedule
                           themselves.&#34;
                        </p>
                     </div>
                     ...
                     >
                        <Image src={img15} alt="logo" className="w-12" />
                        <p className="text-[#5A7795]">
                           &#34;MeetPlanr has changed my life. Finding a
                           mutually convenient time for a meeting is greatly
                           simplified.&#34;
                        </p>
                     </div>
                  </div>
