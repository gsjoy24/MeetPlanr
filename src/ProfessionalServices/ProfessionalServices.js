			...
			<Container>
				<section className="mt-16">
					<div className="lg:grid-cols-2 grid grid-cols-1 gap-16">
						...
						<div>
							<Image src={img1} alt="virtual meeting" data-testid="Image1" />
						</div>
					</div>
				</section>
				...
				<section>
					<div className="my-16">
						<Slider duration={25} pauseOnHover={false} blurBorders={false} blurBorderColor={'#fff'}>
							...
							<Slider.Slide className="mr-16">
								<Image src={img10} alt="Doordash" className="w-40"></Image>
							</Slider.Slide>
						</Slider>
					</div>
				</section>
				...
				<Container>
					...
					<div className="lg:grid-cols-2 mt-36 grid grid-cols-1 gap-16">
						...
						<div data-aos="fade-up" data-aos-duration="900" className="md:order-last">
							<Image src={img12} alt="Service2" data-testid="Image3" className="lg:-mt-8" />
						</div>
					</div>

					<div className="lg:grid-cols-2 grid grid-cols-1 gap-16 mt-24">
						<div data-aos="fade-up" data-aos-duration="900" className="md:order-last lg:order-first order-last">
							<Image src={img11} alt="Service3" data-testid="Image4" className="w-[520px]" />
						</div>
					...
					<div className="lg:grid-cols-2 grid grid-cols-1 gap-16">
						...
						>
							...
							<div className="flex items-center">
								<Image src={img14} alt="Service4" data-testid="Image5" className="w-16 mr-4 rounded-full" />
								<div>
				...
				<Container>
					...
					<div className="my-12">
						<div className="md:grid-cols-3 grid grid-cols-1 gap-16">
							...
							>
								<Image src={img15} alt="Luat1" data-testid="Image6" className="w-12" />
							...
							>
								<Image src={img15} alt="Luat2" data-testid="Image7" className="w-12" />
								<p className="text-[#5A7795]">
							...
							>
								<Image src={img15} alt="Luat3" data-testid="Image8" className="w-12" />
								<p className="text-[#5A7795]">
